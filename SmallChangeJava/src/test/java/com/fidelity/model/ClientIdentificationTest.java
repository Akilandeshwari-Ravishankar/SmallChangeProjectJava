...
public class ClientIdentificationTest {
	...
	void setup() {
		type = "SSN";
		value = "123456";
		clientIdentification = new ClientIdentification(type, value);
	}
	...
	void throw_NullPointerException_When_Type_IsNull() {
		...
		assertThrows(NullPointerException.class, () -> {
			new ClientIdentification(type, value);
		});
	}
	...
	void test_ClientIdentification_HashCode() {
		ClientIdentification clientIdentification1 = new ClientIdentification(type, value);
		ClientIdentification clientIdentification2 = new ClientIdentification(type, value);
		assertEquals(clientIdentification1.hashCode(), clientIdentification2.hashCode());
	}
	
	@Test
	void test_ClientIdentification_EqualityEquals() {
		assertEquals(new ClientIdentification(type, value), clientIdentification);
	}
	
	@Test
	void test_ClientIdentification_InEquality() {
		assertNotEquals(new ClientIdentification("Passport", value), clientIdentification);
	}
	...
	@Test
	void test_toString() {
		assertEquals(clientIdentification.toString(), "ClientIdentification [type=" + type + ", value=" + value + "]");
	}
