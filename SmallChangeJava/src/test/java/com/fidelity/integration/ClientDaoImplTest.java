...
class ClientDaoImplTest {
	...
	Client client1 = new Client("ea0dd5f8-51b8-40b4-ab1e-a386a1c2c515", "Akila", "R", LocalDate.of(2001, 03, 03), "akilayrs@gmail.com", "Testing123*", "IN", "18181818", new ClientIdentification("Passport", "1820192019"));
	Client client2 = new Client("c7cb85bf-c6df-4d43-a23c-d3b0ddd4743b", "Pavithra", "B", LocalDate.of(2000, 01, 01), "pavithrab@gmail.com", "Testing123*", "IN", "18000000", new ClientIdentification("Passport", "18000000"));
	...
	@Test
	void test_daoObjectCreation_NotNull() {
...
//	}
	...
	@Test
	void test_insertNullClient_throwsException() {
	...
	@Test
	void test_insertDuplicateClient_throwsException() {
